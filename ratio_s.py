...
def main():
    ...
    # ⭐ WAV 파일과 강화된 오류 보고 기능이 있는 셔터 소리 재생용 HTML/JavaScript 정의
    SHUTTER_HTML = """
    <audio id="shutter_sound" src="shutter.wav" preload="auto"></audio> 
    <script>
    ...
    if (playPromise !== undefined) {
      playPromise.then(function() {
        ...
        console.error("Audio Playback Failed (Check Autoplay Policy/Source Error):", error);
      });
    }
    </script>
    """
